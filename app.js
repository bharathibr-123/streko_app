...
function renderMain(){
  ...
  viewHabits.forEach((h, i) => {
    ...
    const rowBackground = wrong ? "var(--wrong-bg)" : (done ? rowBg : "transparent");
    const boxBorder = wrong ? "var(--wrong)" : (done ? rowColor : "var(--line)");
    const boxBg = wrong ? "var(--wrong)" : (done ? rowColor : "transparent");
